...
declare namespace WebDriver {
    ...
    interface Client {
        ...
        getElementRect(elementId: string): object;
    ...
    interface Client {
        ...
        getElementText(elementId: string): string;
        getElementTagName(elementId: string): string;
        getElementLocation(elementId: string): object;
        getElementLocationInView(elementId: string): object;
        getElementSize(elementId: string): object;
        isElementEnabled(elementId: string): boolean;
        elementClick(elementId: string): void;
